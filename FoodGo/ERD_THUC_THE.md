...
|-----|-----------|-------------|-------|
| 1 | user_id | VARCHAR(10) (PK) | Mã người dùng (Khóa chính) |
...
| 9 | role | ENUM('customer', 'staff', 'admin') | Vai trò người dùng |
...
### 1.10 ĐƠN HÀNG - KHUYẾN MÃI (Order - Promotion) (tham khảo n-n)
**Thuộc tính:**
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
|-----|-----------|-------------|-------|
...
### 1.11 ĐÁNH GIÁ/NHẬN XÉT (Review/Rating) (duyệt đánh giá trước khi được hiển thị trên web)
**Thuộc tính:**
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
|-----|-----------|-------------|-------|
| 2 | order_id | INT (FK) | Mã đơn hàng (Khóa ngoài) |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
|-----|-----------|-------------|-------|
| 1 | transaction_id | VARCHAR(100) (PK) | Mã giao dịch (Khóa chính) |
| 2 | order_id | INT (FK) | Mã đơn hàng (Khóa ngoài) |
| 3 | user_id | INT (FK) | Mã người dùng (Khóa ngoài) |
...
| Promotion | áp dụng cho | Order | 1:N | Nhiều khuyến mãi cho nhiều đơn hàng |
